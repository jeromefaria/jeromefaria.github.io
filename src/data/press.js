...
export const pressQuotes = [
  ...
  {
    id: 'indierockmag-nny',
    quote: 'A particular talent for atmospheric progressions, interweaving ethereal instrumentals into an organic and hypnotic movement with the allure of a waking dream.',
