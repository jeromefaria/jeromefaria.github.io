...
export const pressQuotes: PressQuote[] = [
  {
    ...
    quote: {
      en: "An almost romantic sound that recalls Eno's <em>Discreet Music</em>, with the additional creak of wind-up toys and waves of static that seem broadcast from the beach.",
      pt: 'Um som quase romântico que evoca <em>Discreet Music</em> de Eno, com o rangido adicional de brinquedos de corda e ondas de estática que parecem transmitidas da praia.',
    },
    source: 'The Quietus',
  ...
  },
  {
    ...
    quote: {
      ...
      pt: 'O madeirense oscilou habilmente entre uma espécie de doom electrónico e um ambient subtil e epidérmico. Como se encarnasse duas faces da mesma moeda, Jerome foi ora libertador ora castigador, ora meditativo ora brusco.',
    },
    source: 'Bodyspace',
