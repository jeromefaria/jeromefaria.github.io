    ...
    items: [
      {
        ...
        tracklist: [
          { title: 'Attack (Prelude)', artist: { text: 'CAVERNANCIA', url: 'https://cavernancia.bandcamp.com/' } },
          { title: 'Sustain II (D00MRemix)', artist: { text: 'Tren Go! Sound System', url: 'https://trengosoundsystem.bandcamp.com/' } },
          { title: 'Overlapse Supercut', artist: { text: 'Aires', url: 'https://aires.bandcamp.com/' } },
          { title: 'Release', artist: { text: 'Fábio Fernandes' } },
          { title: 'Decay III (Sound Kintsugi)', artist: { text: 'João de Nóbrega Pupo', url: 'https://www.instagram.com/jppupo/' } },
          { title: 'Declínio', artist: { text: 'João Vairinhos', url: 'https://joaovairinhos.bandcamp.com/' } },
          { title: 'Costa Norte', artist: { text: 'sol' } },
          { title: 'Release (Conclusion)', artist: { text: 'W. R. Pyo', url: 'https://wrpyo.bandcamp.com/' } },
        ],
  ...
  mastering: {
    ...
    items: [
      ...
      },
      {
        ...
        meta: {
          kind: 'mastering',
          artist: { text: 'Rui P. Andrade', url: 'https://canadian-rifles.bandcamp.com/' },
