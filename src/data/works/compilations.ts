...
export const compilations: WorksSection = {
  title: { en: 'Compilations', pt: 'Compilações' },
  id: 'compilations',
  items: [
    {
      id: 'comp-marrow',
    ...
    },
    {
      ...
      meta: {
        ...
        mediums: ['MP3'],
        editions: [{ label: { text: 'Enough Records' }, catalog: 'ENRCMP07' }],
        released: '2007-12-03',
      },
    },
    {
    ...
    },
    {
      ...
      meta: {
        ...
        mediums: ['CD', 'MP3'],
        editions: [{ label: { text: 'Enough Records' }, catalog: 'ENRCMP06' }],
        released: '2007-06-02',
      },
    },
    {
    ...
    },
    {
      ...
      meta: {
        ...
        mediums: ['MP3'],
        editions: [{ label: { text: 'MiMi Records' }, catalog: 'MI065' }],
        released: '2006-10-26',
      },
    },
    {
      ...
      meta: {
        ...
        mediums: ['MP3'],
        editions: [{ label: { text: 'MiMi Records' }, catalog: 'MI050' }],
        released: '2006-03-01',
      },
    },
    {
      ...
      meta: {
        ...
        mediums: ['MP3'],
        editions: [{ label: { text: 'Enough Records' }, catalog: 'ENRCMP03' }],
        released: '2004-12-18',
      },
    },
  ],
