...
export const solo: WorksSection = {
  title: { en: 'Solo', pt: 'Solo' },
  id: 'solo',
  items: [
    {
      id: 'contraplacado',
    ...
    },
    {
      ...
      tracklist: [
        ...
        { title: 'Fado: Estados Socialistas', start: 205.26 },
        { title: 'Fátima: Estados Ditos Comunistas', start: 571.75 },
        { title: 'Futebol: Estados Capitalistas', start: 930.555 },
        { title: 'Epílogo: Estado a Que Chegamos', start: 1273.58 },
      ],
      credits: {
        style: 'by',
