...
export const pt: MessageSchema = {
  ...
  player: {
    ...
    queue: 'Fila',
    chapters: 'Capítulos',
    viewArtwork: 'Ver a capa',
    exitArtwork: 'Fechar a capa',
  ...
  keyboardHelp: {
    ...
    sectionPalette: 'Paleta de comandos',
    sectionPlayer: 'Leitor de áudio',
    sectionGeneral: 'Geral',
    playPause: 'Reproduzir / pausar',
    seek: 'Recuar / avançar 5 s',
    seekBig: 'Recuar / avançar 10 s',
    changeTrack: 'Faixa anterior / seguinte',
    trackEnds: 'Ir para o início / fim da faixa',
    firstLastTrack: 'Primeira / última faixa',
  },
  contact: {
  ...
  palette: {
    ...
    close: 'Fechar',
    empty: 'Sem resultados — tente um título, cidade ou ano',
    more: 'mais {count} — continue a escrever para reduzir',
    result: 'resultado',
    results: 'resultados',
    ...
    kw: {
      ...
      cv: 'currículo curriculum vitae experiência carreira engenheiro',
      archive: 'arquivo site antigo nny web antiga vault 2004 2010 flash história nostalgia',
      writing: 'ensaio ensaios escrita blog artigos orchestration textos leitura',
      shortcuts: 'ajuda teclas atalhos',
      downloadCv: 'cv currículo curriculum vitae pdf descarregar',
