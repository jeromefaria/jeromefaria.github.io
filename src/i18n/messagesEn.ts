export const en = {
  ...
  keyboardHelp: {
    ...
    sectionPalette: 'Command palette',
    sectionPlayer: 'Audio player',
    sectionGeneral: 'General',
    playPause: 'Play / pause',
    seek: 'Rewind / forward 5s',
    seekBig: 'Rewind / forward 10s',
    changeTrack: 'Previous / next track',
    trackEnds: 'Jump to track start / end',
    firstLastTrack: 'First / last track',
  },
  contact: {
  ...
  palette: {
    ...
    close: 'Close',
    empty: 'No matches — try a title, city, or year',
    ...
    kw: {
      ...
      archive: 'archive old site nny early web vault 2004 2010 flash nostalgia history',
      writing: 'essay essays writing blog articles orchestration reading thoughts',
