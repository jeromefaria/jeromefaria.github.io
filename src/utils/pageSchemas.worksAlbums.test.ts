    ...
    solo: {
      ...
      items: [
        ...
        },
        {
          ...
          meta: { kind: 'music', mediums: ['Digital'], editions: [], released: '2018' },
        },
        {
          id: 'neither',
          title: 'Neither',
          meta: { kind: 'music', mediums: ['Digital'], editions: [], released: '2016' },
        },
      ],
    },
    publications: {
      ...
      items: [
        {
          ...
          meta: { kind: 'publication', publisher: { text: 'A Publisher' }, isbn: { value: '000', url: 'https://example.com/isbn' }, released: '2009' },
        },
      ],
    },
  },
