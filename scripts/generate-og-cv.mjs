...
const cardHtml = `<!doctype html><html><head><meta charset="utf-8"><style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .name { font-size: 92px; font-weight: ${W.semibold}; letter-spacing: ${T.tighter}; line-height: 1; margin-top: 26px; }
  .role { font-size: 40px; font-weight: ${W.medium}; color: ${C.muted}; margin-top: 22px; }
